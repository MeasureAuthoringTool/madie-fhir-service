...
public class MeasureTranslatorServiceTest implements ResourceFileUtil {
  ...
  public void testCreateFhirMeasureForMadieMeasure() {
    ...
    Extension improvementNotationGudianceExt= group1.getExtensionByUrl(UriConstants.CqfMeasures.IMPROVEMENT_NOTATION_GUIDANCE_URI);
    ...
    assertEquals(improvementNotationGudianceExt.getUrl(),UriConstants.CqfMeasures.IMPROVEMENT_NOTATION_GUIDANCE_URI);
    assertThat(improvementNotationGudianceExt.getValue().toString(),is(equalTo("Improvement notation description")));
